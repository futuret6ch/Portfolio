...
export default function BookingModal({ isOpen, onClose }: BookingModalProps) {
  ...
  const handleWhatsAppRedirect = () => {
    ...
    window.open(`https://wa.me/919154619699?text=${text}`, "_blank");
  };
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-3 pt-2">
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-2 rounded-lg border border-[#25D366]/20 bg-[#25D366]/10 hover:bg-[#25D366]/20 px-6 py-3.5 text-sm font-semibold uppercase tracking-wider text-[#25D366] hover:shadow-lg hover:shadow-[#25D366]/20 hover:-translate-y-0.5 transition-all duration-300"
                  >
